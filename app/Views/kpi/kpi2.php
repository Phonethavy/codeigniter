                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">KPI 2: ລາຍຮັບອື່ນໆ</li>
                            </ol>
                        </div>
                    </div>
                    <!--begin::Row-->
                        ...
                        <div class="card mb-4 ">
                            ...
                            <div class="sch1" style="text-align: center;">
                                <div class="flex flex-wrap items-center gap-2 bg-white p-4 rounded shadow-md">
                                    ...
                                    <button class="btn-search flex items-center gap-2 px-4 py-2 rounded shadow">
                                        ...
                                        <div class="modal-content border-danger">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table border-radius-0 table-striped">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr row span="">
                                                ...
                                                <td rowspan="1" class="goal-cell ">8,400,000,000</td>
                                                <td>8,735,562.00 </td>
                                                <td>36,579,304.00</td>
                                                <td>99,041,781.00</td>
                                                <td>169,704,166.00</td>
                                                <td>997,692,680.00</td>
                                                <td>1,379,351,587.00</td>
                                                <td>2,801,693,438.00</td>
                                                <td>3,120,008,786.00</td>
                                                <td>3,412,739,632.00</td>
                                    ...
                                    const salesChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [
                                                {
                                                    label: 'Product A',
                                                    data: [8400000000, 8735562, 36579304, 99041781, 169704166, 997692680, 1379351587, 2801693438, 3120008786, 3412739632, 3834212845, 4187841302],
                                                    fill: true,

...
<title>CMIMFI | ຂໍ້ມູນເງິນຝາກ</title>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ຂໍ້ມູນເງິນຝາກ</li>
                </ol>
              </div>
            </div>
            <!--begin::Row-->
                    ...
                    <tr>
                      <td>
                        <button class="toggle-btn" onclick="toggleRows(this)" data-kpi="1">
                          ...
                          ຈຳນວນເງິນຍອດເຫຼືອລູກຄ້າທັງໝົດ
                        </button>
                      </td>
                      <td><?php echo number_format(rand(100000000, 1000000000), 2); ?></td>
                      <td><?php echo number_format(rand(100000000, 1000000000), 2); ?></td>
                      <td><?php echo number_format(rand(100000000, 1000000000), 2); ?></td>
                      <td><?php echo number_format(rand(100000000, 1000000000), 2); ?></td>
                    ...
                    <tr>
                      <td>
                        <button class="toggle-btn" onclick="toggleRows(this)" data-kpi="3">
                          <span class="toggle-icon"><i class="fa-solid fa-circle-chevron-right"></i></span>
                          ຈຳນວນເງິນທີ່ຮັບຝາກຈາກລູກຄ້າໃຫມ່ ແລະ ເກົ່າ (ເດືອນ)
                        </button>
                      </td>
                      <td><?php echo number_format(rand(100000000, 1000000000), 2); ?></td>
                      <td><?php echo number_format(rand(100000000, 1000000000), 2); ?></td>

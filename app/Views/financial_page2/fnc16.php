            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ອັດຕາສ່ວນການລ້າງໜີ້ສູນ: ຍອດເງີນກູ້ທີ່ຕິດຕາມນອກຜັງ / ຍອດເງິນກູ້ທັງໝົດສະເລ່ຍ ຕ້ອງນ້ອຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ອັດຕາສ່ວນການລ້າງໜີ້ສູນ: ຍອດເງີນກູ້ທີ່ຕິດຕາມນອກຜັງ / ຍອດເງິນກູ້ທັງໝົດສະເລ່ຍ ຕ້ອງນ້ອຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>ຍອດເຫຼືອດອກເບ້ຍ write off	</td>
                    ...
                    <tr class="nested-rows1">
                      <td>ຍອດເຫຼືອເງິນກູ້ write off</td>

          ...
          <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
            <div class="row">
              ...
              <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ອັດຕາສ່ວນຜົນຕອບແທນຈາກຊັບສີນ ROA ຕ້ອງຫຼາຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ອັດຕາສ່ວນຜົນຕອບແທນຈາກຊັບສີນ ROA ຕ້ອງຫຼາຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                  ...
                  const salesChart = new Chart(ctx, {
                    ...
                    data: {
                      ...
                      datasets: [
                        ...
                        // {
                        //   label: 'Product B',
                        //   data: [55, 81, 20, 69, 104, 26, 33, 72, 40, 97, 87, 17, 61, 38],
                        //   fill: true,

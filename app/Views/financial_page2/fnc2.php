            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ອັດຕາສ່ວນທຶນທັງໝົດ / ຊັບສິນທີ່ວາງນ້ຳໜັກຄວາມສ່ຽງ
                    ຕ້ອງຫຼາຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ອັດຕາສ່ວນທຶນທັງໝົດ / ຊັບສິນທີ່ວາງນ້ຳໜັກຄວາມສ່ຽງ ຕ້ອງຫຼາຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>ທຶນ ແລະ ຖືວ່າເປັນທຶນຂອງສະຖາບັນການເງິນ</td>
                    ...
                    <tr class="nested-rows1">
                      <td>ໜີ້ຕ້ອງຮັບຈາກສະຖາບັນການເງິນອື່ນ</td>
                    ...
                    <tr class="nested-rows1">
                      <td>ສິນເຊື່ອ ແລະ ເງິນລ່ວງໜ້າໃຫ້ລູກຄ້າສຸດທິ</td>
                  ...
                  const salesChart = new Chart(ctx, {
                    ...
                    data: {
                      ...
                      datasets: [
                        {
                          label: 'Product A',
                          data: [83, 40, 71, 12, 95, 38, 67, 21, 54, 28, 76, 19, 110, 44],
                          fill: true,
                        ...
                        // {
                        //   label: 'Product B',
                        //   data: [23, 68, 105, 30, 49, 53, 91, 64, 40, 31, 98, 18, 84, 59],
                        //   fill: true,

            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page"> ອັດຕາສ່ວນຊັບສີນຄ່ອງຕົວ ( ເງິນສົດແລະເງິນ ທ/ຄ
                    ທີ່ສາມາດຖອນໄດ້ ) / ຊັບສິນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ອັດຕາສ່ວນຊັບສີນຄ່ອງຕົວ ( ເງິນສົດແລະເງິນ ທ/ຄ ທີ່ສາມາດຖອນໄດ້ ) / ຊັບສິນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>

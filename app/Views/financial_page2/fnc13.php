            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ສະພາບຄ່ອງ 2: (ເງິນສົດໃນມື+ເງິນຝາກຢູ່ສະຖາບັນອື່ນ) /
                    ໜີ້ສີນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</li>
                </ol>
              </div>
            </div>
              ...
              <div class="card-header" style="text-align: center;">
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ສະພາບຄ່ອງ 2: (ເງິນສົດໃນມື+ເງິນຝາກຢູ່ສະຖາບັນອື່ນ) / ໜີ້ສີນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>ເງິນສົດ ແລະ ທີ່ຖືວ່າຄືເງິນສົດ</td>

          ...
          <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
            <div class="row">
              ...
              <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ການກຸ້ມຕົນເອງໃນການດຳເນີນງານ OSS ຕ້ອງຫຼາຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ການກຸ້ມຕົນເອງໃນການດຳເນີນງານ OSS ຕ້ອງຫຼາຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>ລາຍຮັບດອກເບ້ຍ ແລະ ທີ່ຖືຄືວ່າດອກເບ້ຍ</td>
                    ...
                    <tr class="nested-rows1">
                      <td>ລາຍຮັບຄ່າທຳນຽມ ແລະ ຄ່າບໍລິການການເງິນ</td>
                    ...
                    <tr class="nested-rows1">
                      <td>ລາຍຈ່າຍດອກເບ້ຍ ແລະ ທີ່ຖືວ່າຄືດອກເບ້ຍ</td>
                    ...
                    <tr class="nested-rows1">
                      <td>ລາຍຈ່າຍຄ່າທຳນຽມ ແລະ ຄ່າບໍລິການການເງິນ</td>
                    ...
                    </tr><tr class="nested-rows1">
                      <td>ລາຍຈ່າຍບໍລິຫານທົ່ວໄປ</td>
                      <td>26,423,652,995.00</td>
                      <td>27,117,947,514.00</td>
                      <td>24,402,871,964.00</td>
                      <td>23,294,302,631.00</td>
                      ...
                      <td>ລາຍຈ່າຍຄ່າຫຼຸ້ຍຫ້ຽນ ແລະ ຄ່າເຊື່ອມມູນຄ່າ ຊ.ຄ.ທ</td>
                      <td>26,423,652,995.00</td>
                      <td>27,117,947,514.00</td>
                      <td>24,402,871,964.00</td>
                      <td>23,294,302,631.00</td>
                      ...
                      <td>ລາຍຈ່າຍອື່ນໆໃນການທຸລະກິດ</td>
                      <td>26,423,652,995.00</td>
                      <td>27,117,947,514.00</td>
                      <td>24,402,871,964.00</td>
                      <td>23,294,302,631.00</td>
                      ...
                      <td>ສ່ວນການປ່ຽນແປງມູນຄ່າໜີ້ຕ້ອງຮັບ ແລະ ລາຍການນອກໃບສະຫຼຸບຊັບສົມບັດ</td>
                      <td>26,423,652,995.00</td>
                      <td>27,117,947,514.00</td>
                      <td>24,402,871,964.00</td>
                      <td>23,294,302,631.00</td>

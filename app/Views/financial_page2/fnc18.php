            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ລູກຄ້າໜຶ່ງລາຍ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</li>
                </ol>
              </div>
            </div>
              ...
              <div class="card-header" style="text-align: center;">
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ລູກຄ້າໜຶ່ງລາຍ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>Outstanding (ຍອດເຫຼືອເງິນກູ້ທັງໝົດ)</td>

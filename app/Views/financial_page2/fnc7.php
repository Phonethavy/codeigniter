          ...
          <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
            <div class="row">
              ...
              <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ອັດຕາສ່ວນການລະດົມເງິນຝາກ (ເງິນຝາກທັງໝົດ / ທືນຊັ້ນໜຶ່ງ ) ຕ້ອງນ້ອຍກວ່າ</li>
                </ol>
              </div>
            </div>
              ...
              <div class="card-header" style="text-align: center;">
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ອັດຕາສ່ວນການລະດົມເງິນຝາກ (ເງິນຝາກທັງໝົດ / ທືນຊັ້ນໜຶ່ງ ) ຕ້ອງນ້ອຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>ເງິນແຮຕາມຂໍ້ກຳນົດ (ເງິນແຮ່ຄ່າເຊື່ອມເງິນກູ້ປົກກະຕິ)</td>

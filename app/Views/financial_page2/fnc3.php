            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ອັດຕາສ່ວນຜົນຕອບແທນຈາກທຶນ ROE ຕ້ອງຫຼາຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          ອັດຕາສ່ວນຜົນຕອບແທນຈາກທຶນ ROE ຕ້ອງຫຼາຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                  ...
                  const salesChart = new Chart(ctx, {
                    ...
                    data: {
                      ...
                      datasets: [
                        ...
                        // {
                        //   label: 'Product B',
                        //   data: [59, 48, 99, 66, 22, 90, 84, 37, 60, 26, 35, 101, 77],
                        //   fill: true,

          ...
          <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
            <div class="row">
              ...
              <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">ການກູ້ຢືມ: ການກູ້ຍືມຈາກພາຍນອກທັງໝົດ / ຍອດສີນເຊື່ອທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</li>
                </ol>
              </div>
            </div>
                ...
                <div class="table-container">
                  <table>
                    ...
                    <tbody>
                      <tr row span="">
                        <td>
                          ການກູ້ຢືມ: ການກູ້ຍືມຈາກພາຍນອກທັງໝົດ / ຍອດສີນເຊື່ອທັງໝົດ ຕ້ອງນ້ອຍກວ່າ
                        </td>
                        <td>12%</td>
                        <td>18.18%</td>
                        <td>18.23%</td>
                ...
                <div class="table-container">
                  <table class="table table-bordered table-striped">
                    ...
                    <tr class="nested-rows1">
                      <td>ເງິນໃຫ້ກູ້ຢືມ ແລະ ເງິນລ່ວງໜ້າສຸດທິ</td>
                  ...
                  const salesChart = new Chart(ctx, {
                    ...
                    data: {
                      ...
                      datasets: [
                        ...
                        // {
                        //   label: 'Product B',
                        //   data: [90, 46, 60, 85, 28, 64, 32, 77, 106, 48, 91, 24, 39],
                        //   fill: true,
